...
import '../Model/ModelMiscMachineList.dart';
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        if (_formKey.currentState!.validate()) {
                          ...
                          controller.addMiscList(ModelMachineMisc(
                              machineName:
                                  controller.machineNameTextController.text,
                              unit: int.parse(controller.average.text),
                  ...
                  onPressed: () {
                    if (key.currentState!.validate()) {
                      controller.updateTask(
                        controller.machineNameTextController.text,
                        int.parse(controller.average.text.toString()),
                        int.parse(controller.deviation.text.toString()),
