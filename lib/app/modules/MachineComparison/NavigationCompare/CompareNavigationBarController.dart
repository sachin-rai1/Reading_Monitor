...
import 'package:readingmonitor2/app/modules/MachineComparison/Compare_Utility/controllers/compare_utility_controller.dart';
...
class CompareTabBarController extends GetxController
  ...
  indexSelection() {
    if (selectedIndex == 0) {
      Get.delete<CompareUtilityController>();
